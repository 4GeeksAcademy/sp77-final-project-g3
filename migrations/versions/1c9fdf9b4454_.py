...
Revision ID: 1c9fdf9b4454
Revises: 
Create Date: 2024-10-11 19:20:26.790806
...
def upgrade():
    ...
    sa.Column('type_source', sa.Enum('bank_account', 'manual_entry', 'credit_card', 'debit_card', 'ohers', name='type_source'), nullable=False),
