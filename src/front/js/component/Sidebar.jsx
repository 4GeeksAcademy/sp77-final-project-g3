            ...
            <ul className="nav nav-pills flex-column mb-auto list-unstyled flex-grow-1">
                <li className="nav-item mb-3 ms-2">
                    <Link className="fw-bold sidebar-link" to="/">
                        <i class="fa-solid fa-home bi pe-none me-2" style={{ width: '16', height: '16' }}></i>
                        Home
                    </Link>
                </li>
                <li className="mb-3 ms-2">
                    <Link className="fw-bold sidebar-link" to="/dashboard">
                        <i class="fa-solid fa-table-columns bi pe-none me-2" style={{ width: '16', height: '16' }}></i>
                        Dashboard
                    </Link>
                </li>
                <li className="mb-3 ms-2">
                    <Link className="fw-bold sidebar-link" to="/transactions">
                        <i class="fa-solid fa-money-bill-transfer bi pe-none me-2" style={{ width: '16', height: '16' }}></i>
                        Transactions
                    </Link>
                </li>
                <li className="mb-3 ms-2">
                    <Link className="fw-bold sidebar-link" to="/budgets">
                        <i class="fa-solid fa-sack-dollar bi pe-none me-2" style={{ width: '16', height: '16' }}></i>
                        Budgets
                    </Link>
                </li>
                <li className="mb-3 ms-2">
                    <Link className="fw-bold sidebar-link" to="/balance">
                        <i class="fa-solid fa-scale-balanced bi pe-none me-2" style={{ width: '16', height: '16' }}></i>
                        Balance
                    </Link>
                </li>
                <li className="mb-3 ms-2">
                    <Link className="fw-bold sidebar-link" to="/fixed-expenses">
                        <i class="fa-solid fa-file-invoice bi pe-none me-2" style={{ width: '16', height: '16' }}></i>
                        Fixed Expenses
                    </Link>
                </li>
                <li className="mb-3 ms-2">
                    <Link className="fw-bold sidebar-link" to="/connections">
                        <i class="fa-solid fa-circle-nodes bi pe-none me-2" style={{ width: '16', height: '16' }}></i>
                        Connections
                    </Link>
                </li>
                <li className="mb-3 ms-2">
                    <Link className="fw-bold sidebar-link" to="/guide">
                        <i class="fa-solid fa-book bi pe-none me-2" style={{ width: '16', height: '16' }}></i>
                        Guide
                    </Link>
                </li>
                <li className="mb-3 ms-2">
                    <Link className="fw-bold sidebar-link" to="/faq">
                        <i class="fa-solid fa-circle-question bi pe-none me-2" style={{ width: '16', height: '16' }}></i>
                        FAQ
                    </Link>
                </li>
                <li className="mb-3 ms-2">
                    <Link className="fw-bold sidebar-link" to="/contact">
                        <i class="fa-solid fa-envelope bi pe-none me-2" style={{ width: '16', height: '16' }}></i>
                        Contact
                    </Link>
                </li>
            </ul>
