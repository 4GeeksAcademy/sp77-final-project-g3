...
from .models import db, Users, Institutions, Connections, Sources, Balances, Categories, Transactions, FixedExpenses, Budgets
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(Institutions, db.session))
